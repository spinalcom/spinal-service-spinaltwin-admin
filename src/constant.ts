...
export const SPINALTWIN_ADMIN_SERVICE_APP_RELATION_TYPE_LST_PTR = 'LstPtr';

// RelationName
export const SPINALTWIN_ADMIN_SERVICE_APP_GROUP_RELATION_NAME =
  'SpinalTwinListHasAppGroup';
export const SPINALTWIN_ADMIN_SERVICE_APP_RELATION_NAME =
...
export const APP_PROFILE_LIST = 'AppProfileList';
